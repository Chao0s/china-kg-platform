// Shared utilities for the China KG Platform harness (pure Node ESM, no deps).
// Used by glossary-check.mjs, typewriter.mjs, and gate.mjs.
...
export function walk(target, exts, ignore = ['node_modules', '.git', 'dist', '.understand-anything', '.planning']) {
  const out = [];
